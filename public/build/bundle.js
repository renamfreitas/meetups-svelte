...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 22, 2, 359);
    			attr_dev(header, "class", "svelte-1jeem7x");
    			add_location(header, file$2, 21, 0, 348);
    		},
    ...
    /* src/Meetups/MeetupItem.svelte generated by Svelte v3.46.6 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p1, file$1, 73, 4, 1064);
    			attr_dev(div1, "class", "content svelte-8tjse");
    			add_location(div1, file$1, 72, 2, 1038);
    			attr_dev(a, "href", a_href_value = "mailto:" + /*contactEmail*/ ctx[5]);
    			add_location(a, file$1, 76, 4, 1109);
    			add_location(button0, file$1, 77, 4, 1161);
    			add_location(button1, file$1, 78, 4, 1195);
    			attr_dev(footer, "class", "svelte-8tjse");
    			add_location(footer, file$1, 75, 2, 1096);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file, 34, 0, 851);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
